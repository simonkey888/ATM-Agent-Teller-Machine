...
class MandatoryR3ANegativeControls(unittest.TestCase):
    ...
    def test_live_workflows_bind_environment_and_forbid_ephemeral_workprotocol_identity(self):
        ...
        self.assertIn("steps.legal.outputs.write_ready == 'true'", submit)
        self.assertNotIn("steps.legal.outputs.accepted == 'true'", submit)
        self.assertIn("LEGAL_WRITE_READY", submit)
