...
class Order006WorkerIntegrationTests(unittest.TestCase):
    ...
    def test_readiness_registration_is_not_activation(self):
        ...
        self.assertEqual(zungun.source_pin, "7c407cc5e39ec0698a6763ea621eba5e87d832b8")
        ...
        self.assertEqual(across.source_pin, "1990694cb1027331f4700e95d739550beff0c539")
        self.assertEqual(self.manifests.get("zungun").worker_version, "1.0.0-ready-c95002f+atm-7c407cc")
        self.assertEqual(self.manifests.get("across-edge").worker_version, "1.0.0-ready-f65e597+atm-1990694")
